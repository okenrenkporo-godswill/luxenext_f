        ...
        <div className="hidden lg:flex w-1/2 bg-[#0e4b31] relative overflow-hidden flex-col justify-center p-16">
            ...
            <div className="relative z-10">
                ...
                <div className="relative mt-20">
                    {/* Main Card UI Mockup */}
                    <div className="w-[340px] h-[400px] bg-white rounded-[2rem] shadow-2xl p-8 flex flex-col justify-between ml-auto transform translate-x-4 hover:translate-x-2 transition-transform duration-500">
